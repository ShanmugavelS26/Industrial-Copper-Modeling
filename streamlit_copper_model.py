...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"dataset/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'dataset/scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"dataset/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"dataset/s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"dataset/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'dataset/cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"dataset/ct.pkl", 'rb') as f: 
            ...
            if new_pred==1:
                ...
                st.write(new_pred,"predict value")
            else:
                st.write('## :red[The status is Lost] ')
                st.write(new_pred,"predict value")

st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Shanmugavel</h6>', unsafe_allow_html=True )  